      ...
      <div class="container-login100" style="background-image: url('../img/img6.jpg')">
        ...
        <a href="../rentcar.php" class="btn btn-back" style="width: 100px;margin-left:-30px;margin-top:-75px">Back</a>
          <form class="login100-form validate-form" action="../pemesanan.php" method="POST">
            <span class="login100-form-title" style="margin-top: 0;">HONDA CIVIC-R</span>
            <h4 class="margin0 text-center" style="font-size: 17px;">AD 2581 XR</h4>
            <div class="car-item">
              <img class="img-fluid" src="../img/car/honda-civic.png" style="width:50%; display:block;margin:auto;padding-bottom:90px"/>
            ...
            <a href="?beli=6" class="btn btn-lamasewa" type="button">
