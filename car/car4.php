      ...
      <div class="container-login100" style="background-image: url('../img/img6.jpg')">
        ...
        <a href="../rentcar.php" class="btn btn-back" style="width: 100px;margin-left:-30px;margin-top:-75px">Back</a>
          <form class="login100-form validate-form" action="../pemesanan.php" method="POST">
            <span class="login100-form-title" style="margin-top: 0;">DAIHATSU TERIOS</span>
            <h4 class="margin0 text-center" style="font-size: 17px;">AD 4586 JK</h4>
            <div class="car-item">
              <img class="img-fluid" src="../img/car/daihatsu-terios.png" style="width:50%; display:block;margin:auto;margin-top:40px;padding-bottom:110px"/>
              <div class="car-caption space-text-car-bmw">
            </div>
            <span class="login100-form-title" style="margin-top: -90px;font-size:28px;padding-bottom:30px"> Form Penyewaan </span>
            <div
            ...
            <a href="?beli=4" class="btn btn-lamasewa" type="button">
