      ...
      <div class="container-login100" style="background-image: url('../img/img6.jpg')">
        ...
        <a href="../rentcar.php" class="btn btn-back" style="width: 100px;margin-left:-30px;margin-top:-75px">Back</a>
          <form class="login100-form validate-form" action="../pemesanan.php" method="POST">
            <span class="login100-form-title" style="margin-top: 0;">TOYOTA INNOVA</span>
            <h4 class="margin0 text-center" style="font-size: 17px;">AD 8821 IA</h4>
            <div class="car-item">
              <img class="img-fluid" src="../img/car/toyota-innova.png" style="width:50%; display:block;margin:auto;margin-top:-30px;padding-bottom:100px"/>
              <div class="car-caption space-text-car-bmw">
            </div>
            <span class="login100-form-title" style="margin-top: -130px;font-size:28px;padding-bottom:30px"> Form Penyewaan </span>
            <div
            ...
            <!-- <div
              ...
              data-validate="Password is required"
            >
              <span class="label-input100">Lama Pesan</span>
              <input
                class="input100"
                type="text"
                name="lama-pesan"
                id="lama-pesan"
                placeholder="Masukan lama pesan"
                value="<?php echo $lama_pesan ?>"
              />
              <span class="focus-input100"></span>
            </div> -->

            <a href="?beli=21" class="btn btn-lamasewa" type="button">
