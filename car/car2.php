      ...
      <div class="container-login100" style="background-image: url('../img/img6.jpg')">
        ...
        <a href="../rentcar.php" class="btn btn-back" style="width: 100px;margin-left:-30px;margin-top:-75px">Back</a>
          <form class="login100-form validate-form" action="../pemesanan.php" method="POST">
            <span class="login100-form-title" style="margin-top: 0;">BMW i8</span>
            <h4 class="margin0 text-center" style="font-size: 17px;">AD 5576 FO</h4>
            <div class="car-item">
              <img src="../img/car/bmw-i8.png" style="width:50%; display:block;margin:auto;margin-top:-50px;padding-bottom:100px"/>
              <div class="car-caption space-text-car-bmw">
            </div>
            <span class="login100-form-title" style="margin-top: -200px;font-size:28px;padding-bottom:30px"> Form Penyewaan </span>
            <div
            ...
            <a href="?beli=2" class="btn btn-lamasewa" type="button">
